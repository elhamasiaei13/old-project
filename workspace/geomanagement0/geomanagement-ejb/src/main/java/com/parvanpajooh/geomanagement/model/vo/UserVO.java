...
public class UserVO implements Serializable {
	...
	private GeneralAgentVO rarAgentVO;
	...
	/**
	 * @return the rarAgentVO
	 */
	public GeneralAgentVO getRarAgentVO() {
		return rarAgentVO;
	}

	/**
	 * @param rarAgentVO the rarAgentVO to set
	 */
	public void setRarAgentVO(GeneralAgentVO rarAgentVO) {
		this.rarAgentVO = rarAgentVO;
	}
