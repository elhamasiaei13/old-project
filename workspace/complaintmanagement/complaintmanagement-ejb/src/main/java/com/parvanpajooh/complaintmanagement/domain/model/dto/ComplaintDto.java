...
public class ComplaintDto extends BaseDto {
	...
	public ComplaintMsg toMsg() {
		...
		if (this.createDate != null) {
			String createDateTimeStr = DateUtilV2.formatLocalDateTimeToStringDateTime(
					DateUtilV2.PATTERN_ISO__yyyyMMdd_HHmm, 
					this.createDate);
			msg.setCreateDate(createDateTimeStr);
		}

		if (this.updateDate != null) {
			String updateDateTimeStr = DateUtilV2.formatLocalDateTimeToStringDateTime(
					DateUtilV2.PATTERN_ISO__yyyyMMdd_HHmm, 
					this.updateDate);
			msg.setUpdateDate(updateDateTimeStr);
		}
